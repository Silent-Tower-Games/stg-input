...
static const char* STGInput_KeyboardKeys_Names[STGINPUT_KEYBOARDSTATE_KEYCODES_COUNT] = {
    "Unknown",
    "Return",
    "Escape",
    "Backspace",
...
{
    if (key < 0 || key >= STGINPUT_KEYBOARDSTATE_KEYCODES_COUNT) {
        return "---";
    }
    
    return STGInput_KeyboardKeys_Names[key];
}
