...
lib:
	make objs-lib
	${CC} ${CFLAGS} src/STGInput/AxisState.o src/STGInput/ButtonState.o src/STGInput/GamepadState.o src/STGInput/KeyboardState.o src/STGInput/MouseState.o src/STGInput/STGInput.o -shared -o libstginput.so `sdl2-config --libs`

lib-static:
	make objs-lib
	ar rcs libstginput.a src/STGInput/AxisState.o src/STGInput/ButtonState.o src/STGInput/GamepadState.o src/STGInput/KeyboardState.o src/STGInput/MouseState.o src/STGInput/STGInput.o
