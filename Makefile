...
lib:
	make objs-lib
	${CC} ${CFLAGS} src/ButtonState.o src/GamepadState.o src/KeyboardState.o src/STGInput.o -shared -o libstginput.so `sdl2-config --libs`

lib-static:
	make objs-lib
	ar rcs libstginput.a src/ButtonState.o src/GamepadState.o src/KeyboardState.o src/STGInput.o
